...
public class SmoothCheckBox extends View implements Checkable{
    ...
    private void init(AttributeSet attrs){
       TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.SmoothCheckBox);
        ...
        mStrokeWidth = ta.getInt(R.styleable.SmoothCheckBox_stroke_width, CompatUtils.dp2px(getContext(), 0));
        ta.recycle();
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        if(state instanceof Bundle){
            ...
            boolean isChacked = bundle.getBoolean(KEY_INSTANCE_STATE);
            setChecked(isChacked);
